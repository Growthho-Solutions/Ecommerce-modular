    ...
    <div className="container mx-auto px-6 py-24 flex items-center justify-center">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center space-y-2">
          <h1 className="text-4xl font-black tracking-tighter">Join the Club</h1>
          <p className="text-muted-foreground italic">Create your Growthho account to start shopping premium essentials.</p>
        </div>
